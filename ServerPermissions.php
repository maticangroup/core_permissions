...
class ServerPermissions
{
    ...
    const repository_company_setcontainer = 'repository_company_setcontainer';
    const repository_company_getsubscribedservices = 'repository_company_getsubscribedservices';
}